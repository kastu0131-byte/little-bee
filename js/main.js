...
const i18nData = {
    ...
    en: {
        ...
        menu_fleet: "Fleet",
        menu_about: "About Us",
        hero_title1: "Osaka KIX · Premium Transfer",
        hero_sub1: "Toyota Granace First Class Experience",
        scene_title: "Premium Travel Scenarios",
        scene_1_t: "Business Reception",
        scene_1_d: "Professional airport pickup with sign, multilingual driver.",
        scene_2_t: "Family Travel",
        scene_2_d: "Spacious interior for the whole family, customized Kansai tours.",
        scene_3_t: "Golf Special",
        scene_3_d: "Extra large luggage space, punctual transfers to golf courses.",
        why_us_title: "Safety & Compliance",
        why_us_1_t: "Registered Green Plate",
        why_us_1_d: "Fully insured commercial vehicles, legal and safe operation.",
        why_us_2_t: "Expert Drivers",
        why_us_2_d: "5+ years experience, fluent in local geography and culture.",
        why_us_3_t: "Price Transparency",
        why_us_3_d: "All-inclusive pricing (fuel & insurance), no hidden fees.",
        area_title: "Service Area",
        area_desc: "Serving Kansai: Osaka, Kyoto, Nara, Kobe, Wakayama.",
        process_title: "Booking Process",
        step_1: "1. Inquiry",
        step_2: "2. Quote",
        step_3: "3. Payment",
        step_4: "4. Journey",
        footer_about: "About LITTLE BEE",
        footer_desc: "Based in Osaka, focused on Kansai. Providing top-tier compliant transportation.",
        footer_contact: "Contact",
        footer_company: "Company Profile",
        fleet_page_title: "Flagship Fleet",
